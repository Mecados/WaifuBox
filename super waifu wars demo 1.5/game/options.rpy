...
init -1 python hide:
    ...
    config.window_title = u"Super Waifu Wars Demo"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Super Waifu Wars Demo"
    config.version = "0.0"
    ...
    style.button.activate_sound = "beep.wav"
...
# 2015/05/26: BQ -- added main menu music
    config.main_menu_music = "music_SpaceExplorers.mp3"
...
python early:
    config.save_directory = "Super Waifu Wars Demo-1432011113"
...
init python:
    ...
    build.directory_name = "SWW-Demo-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "SWW-Demo"
